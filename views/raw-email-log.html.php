                ...
                <form method="post">
                    <div class="arigato-admin-form-group">
                        ...
                        <div class="arigato-admin-col">
                            <input type="text" name="start_date" class="datepicker arigato-admin-col-xs" value="<?php echo esc_attr($start_date)?>"> - <input type="text" name="end_date" class="datepicker arigato-admin-col-xs" value="<?php echo esc_attr($end_date)?>">
                    ...
                    <div class="arigato-admin-form-group">
                        ...
                        <div class="arigato-admin-col">
                            <input type="text" class="arigato-admin-col-xs" name="cleanup_days" value="<?php echo intval($cleanup_raw_log)?>">
