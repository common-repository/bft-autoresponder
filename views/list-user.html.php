        ...
        <section>
            ...
            <form method="post">
                <div class="arigato-admin-form-group-column">
                    ...
                    <input type="text" name="email" value="<?php echo esc_attr($user->email)?>" class="arigato-admin-col-4">
                </div>
                <div class="arigato-admin-form-group-column">
                    <label><?php _e('User name:', 'broadfast');?></label>
                    <input type="text" name="user_name" value="<?php echo esc_attr($user->name)?>" class="arigato-admin-col-4">
                </div>
                <div class="arigato-admin-form-group-column">
