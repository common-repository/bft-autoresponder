                    ...
                    <div class="postbox">
                        ...
                        <form method="post">
                            ...
                            <div class="arigato-admin-form-group">
                                ...
                                <input type="text" name="bft_sender" value="<?php echo esc_attr($bft_sender)?>" class="arigato-admin-col-7">
                            </div>
                            ...
                            <div class="arigato-admin-form-group-column">
                                ...
                                <input type="text" name="bft_redirect" value="<?php echo esc_url_raw($bft_redirect)?>" class="arigato-admin-col-12">
                            </div>
                            <div class="arigato-admin-form-group">
                ...
                <div class="arigato-admin-col-6 top">
                    <div class="postbox">
                       ...
                       <?php if(class_exists('FrmField')):?><p align="center"><a href="admin.php?page=bft_integrate_formidable"><?php _e('Integrate in Formidable Form', 'broadfast');?></a></p><?php endif;?>
                        <?php if(defined('WPFORMS_VERSION')):?><p align="center"><a href="admin.php?page=bft_integrate_wpf"><?php _e('Integrate in WPForms', 'broadfast');?></a></p><?php endif;?>
                    </div>
