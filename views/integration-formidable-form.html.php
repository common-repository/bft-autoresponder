            ...
            <form method="post" class="broadfast">
                <div class="postbox wp-admin">
                    ...
                    <div class="arigato-admin-form-group">
				        ...
				        <p class="arigato-admin-col-8 arigato-help"><?php _e("You can choose a checkbox from the Formidable form that shoud be selected to subscribe the user in the list. If you don't select such checkbox, everyone who submits the associated WPforms form will be subscribed to the mailing list.", 'broadfast');?></p>
                    </div>
